...
namespace ProjectManager.Client.Services
{
    public class ProjectService : IProject
    {
                                                ...
                                                public async Task<List<ProjectDto>> List()
        {
            ...
            if (projects == null)
            {
                throw new ApplicationException("Error while getting projects");
            }
                                                        ...
                                                        public async Task<ProjectDto> Get(Guid projectId)
        {
            ...
            if (project == null)
            {
                throw new ApplicationException($"Error while getting {EntityName}");
            }
                                                        ...
                                                        public async Task<ProjectDto> Create(ProjectDto project)
        {
            ...
            if (newProject == null)
            {
                throw new ApplicationException($"Could not retrieved the created ${EntityName}");
            }
                                                                ...
                                                                public async Task<ProjectDto> Update(Guid projectId, ProjectDto project)
        {
            ...
            {
                throw new ApplicationException($"Error while updating ${EntityName}");
            }
                                                                ...
                                                                public async Task<ProjectDto> ModifyUser(Guid projectId, UserDto user)
        {
            ...
            if (updatedProject == null)
            {
                throw new ApplicationException($"Error while modifying ${EntityName} users");
            }
